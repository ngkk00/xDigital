...
const models: TsoaRoute.Models = {
    ...
    "Task": {
        ...
        "properties": {
            ...
            "subtasks": {"dataType":"array","array":{"dataType":"refObject","ref":"Task"}},
            "parentTask": {"dataType":"union","subSchemas":[{"ref":"Task"},{"dataType":"enum","enums":[null]}],"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "CreateTaskRequest": {
        ...
        "properties": {
            "title": {"dataType":"string","required":true},
            "requiredSkillIds": {"dataType":"array","array":{"dataType":"string"}},
            "subtasks": {"dataType":"array","array":{"dataType":"refObject","ref":"CreateTaskRequest"}},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/api/tasks/:taskId/unassign',
            ...(fetchMiddlewares<RequestHandler>(TaskController)),
